...
public class QuoteStatusesController(ILogger<QuoteStatusesController> logger, IServiceProvider serviceProvider) : ControllerBase
{
    private readonly ILogger<QuoteStatusesController> _logger = logger;
