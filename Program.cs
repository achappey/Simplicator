...
static IEdmModel GetGraphModel(string name)
{
    ...
    builder.EntitySet<Simplicate.NET.Models.Interest>("Interests").EntityType.Namespace = name;
    ...
    builder.ComplexType<Simplicate.NET.Models.PaymentTermLookup>().Namespace = name;
